...
print(X+"         اهلا بك في اداة رشق مشاهدات تليجرام ")
print(X+"         مطور الاداة توباك :- @iiit5 ")
print(X+"        قناة المطور :- @OYOYV ")
time.sleep(2)
os.system("clear")

print(B+lo)
print("")
print(X+"      ادخل هنا روابط المنشوات تريد رشق المشاهدات لها ") 
webbrowser.open('https://t.me/OYOYV')
print("")
link1=input('\033[1;31mادخل رابط المنشور الاول : ')
